								...
								<div class="featured-img-box">
									...
									<div class="featured-model-info">
										<p>
                                            ...
                                            <a href="{{ route('corolla') }}" class="btn btn-primary btn-sm">Buy Accessories</a>
								...
								<div class="featured-img-box">
									...
									<div class="featured-model-info">
										<p>
                                            ...
                                            <a href="{{ route('civic') }}" class="btn btn-primary btn-sm">Buy Accessories</a></td>
								...
								<div class="featured-img-box">
									...
									<div class="featured-model-info">
										<p>
											...
											<a href="{{ route('swift') }}" class="btn btn-primary btn-sm">Buy Accessories</a></td>
